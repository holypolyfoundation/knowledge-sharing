...
- Set `ascii_seed` to `null`, `"zero-one"`, `"fire"`, `"radar"`, `"starfield"`, `"circuit-pulse"`, `"equalizer"`, `"packet-flow"`, `"tide"`, `"hourglass"`, `"forge"`, `"swarm"`, `"glitch-banner"`, `"terminal"`, or `"game-of-life"`
