...
> Хочу отримувати сповіщення про нові івенти Polymarket пов`язані з землетрусами. В мене є думки про потенцийну статегію, хочу мати можливісь дізнаватись про нові івенти з цієї категорії якогома швидше.
...
Вимоги:
- Задай мені питання, що допоможуть тобі зібрати більше деталей про проблемі та допоможуть правильно реалізувати инструмент
...
- Перед вирішенням як реалізовувати бота проаналізуй API https://docs.polymarket.com/api-reference/introduction. Вияви потенційни механізми, що ми можемо використати для вирішення нашої проблеми
...
> API-ключі, не світити ключі в чатах, перевірка «чи модель не вигадала endpoint».
...
Починаємо коло заново, просимо провалідувати AI написаний код, просимо підсвітити слабкі місця та зони покращення.
...
- Свій ПК / ноутбук. Мінус — машина має бути ввімкнена 24/7 + залежність від домашнього інтернету; Плюс - безкоштовно + просто.
